...
[Vercel](https://vercel.com)에 접속해서, 프로젝트를 `import`하고,
Settings의 Environment Variables에 이전에 만들었던 `.env` 파일의 환경 변수를 등록하자.

배포가 완료되면, 생성된 URL로 접속해본다. 오류없이 동작한다면 모든 단계가 완료되었다.

## 구현 결과

- 99Club: https://99club-coding-study.vercel.app
