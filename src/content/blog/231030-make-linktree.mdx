...
pubDate: '2023-10-30'
heroImage: 'src/assets/link-tree.png'
categories: ['Tech']
author: 'woongsnote'
...
구현한 결과물은 <a href="https://woongsnote.github.io" target="_blank">여기</a>에서 확인할 수 있고, 프로젝트의 전체 소스 코드는 <a href="https://github.com/woongsnote/woongsnote.github.io" target="_blank">여기</a>에서 확인할 수 있다.
